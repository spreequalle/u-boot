...
#define CONFIG_SERVERIP 192.168.0.100 //10.10.10.3
#define CONFIG_IPADDR 192.168.0.50 //10.10.10.123
...
#define CFG_CONFIG_SIZE		0x40000   // 0x20000 for database, 0x20000 for language pack
